        ...
        <motion.div className="container max-w-9xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <motion.div>
                <div className='flex items-center gap-2'>
                    <h4 className="text-lg sm:text-xl font-semibold mb-2 text-yellow-300">Contatos</h4>
                    <IoLogoWhatsapp className='text-yellow-300 mb-2 text-2xl' />
                </div>
                <p className="text-sm sm:text-base">
                    Email:{' '}
                    <a href={`mailto:${email}`} className="underline hover:text-emerald-400 transition">
                        {email}
                    </a>
                </p>
            ...
            <motion.div>
                <div className='flex items-center gap-2'>
                    <h4 className="text-lg sm:text-xl font-semibold mb-2 text-yellow-300">Horario</h4>
            ...
            <motion.div>
                <div className='flex items-center gap-2'>
                    <h4 className="text-lg sm:text-xl font-semibold mb-2 text-yellow-300">Endereço</h4>
                    <MdLocationPin className='text-yellow-300 mb-2 text-2xl' />
                </div>
                <a href='https://g.co/kgs/PT8JA4j' className="text-sm sm:text-base whitespace-pre-line underline hover:text-emerald-400 transition">{endereco}</a>
            </motion.div>
